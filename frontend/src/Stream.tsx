        ...
        <>
            <div class="flex">
                ...
                <aside class="w-64" aria-label="Sidebar">
                    <div class="overflow-y-auto px-3 bg-neutral rounded overflow-y-auto">
                        <ul class="space-y-2">
