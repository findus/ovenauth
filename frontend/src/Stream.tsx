        ...
        <>
            <div class="flex">
                ...
                <aside class="w-64" aria-label="Sidebar">
                    <div class="overflow-y-auto py-4 px-3 bg-neutral rounded">
                        <ul class="space-y-2">
                            <For each={chatService().viewers}>
                                {(viewer) =>
                                    <li>
                                        <a href="#" class="flex items-center p-2 text-base font-normal text-base-content rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
